 ...
 */
package com.eunoiaos.eunoiaparts.search;
 ...
 */
public class EunoiaPartsSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = EunoiaPartsSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_ICON_RESID] = R.drawable.ic_launcher_eunoiaos;
            ref[COLUMN_INDEX_XML_RES_INTENT_ACTION] = i.getAction();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = EUNOIAPARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = EUNOIAPARTS_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_ICON_RESID] = raw.iconResId > 0 ? raw.iconResId :
                        (i.getIconRes() > 0 ? i.getIconRes() : R.drawable.ic_launcher_eunoiaos);
                ...
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = raw.intentTargetPackage != null ?
                        raw.intentTargetPackage : EUNOIAPARTS_ACTIVITY.getPackageName();
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = raw.intentTargetClass != null ?
                        raw.intentTargetClass : EUNOIAPARTS_ACTIVITY.getClassName();
