...
/**
 * This activity handles NDEF_DISCOVERED intents with the "eunoia/profile" mime type.
...
public class NFCProfile extends Activity {
    ...
    static final String PROFILE_MIME_TYPE = "eunoia/profile";
    ...
    private void handleProfileMimeType(byte[] payload) {
        ...
        boolean enabled = EunoiaSettings.System.getInt(getContentResolver(),
