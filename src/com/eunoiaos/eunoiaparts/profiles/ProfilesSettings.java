...
public class ProfilesSettings extends SettingsPreferenceFragment
    ...
    public void onStart() {
        ...
        mProfileEnabler.getSwitch().setOnCheckedChangeListener((buttonView, isChecked) -> {
            EunoiaSettings.System.putInt(activity.getContentResolver(),
                    EunoiaSettings.System.SYSTEM_PROFILES_ENABLED, isChecked ? 1 : 0);
        });
    ...
    private void updateProfilesEnabledState() {
        ...
        mEnabled = EunoiaSettings.System.getInt(activity.getContentResolver(),
