...
public class NotificationLightSettings extends SettingsPreferenceFragment implements
    ...
    private EunoiaSystemSettingSwitchPreference mCustomEnabledPref;
    private EunoiaSystemSettingSwitchPreference mScreenOnLightsPref;
    private EunoiaSystemSettingSwitchPreference mAutoGenerateColors;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mNotificationBrightnessPref =
                findPreference(EunoiaSettings.System.NOTIFICATION_LIGHT_BRIGHTNESS_LEVEL);
        mScreenOnLightsPref =
    ...
    private void refreshDefault() {
        ...
        int color = EunoiaSettings.System.getInt(resolver,
                EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_COLOR, mDefaultColor);
        int timeOn = EunoiaSettings.System.getInt(resolver,
                EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_ON, mDefaultLedOn);
        int timeOff = EunoiaSettings.System.getInt(resolver,
                EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_DEFAULT_LED_OFF, mDefaultLedOff);

        mDefaultPref.setAllValues(color, timeOn, timeOff);

        // Get Missed call and Voicemail values
        if (mCallPref != null) {
            int callColor = EunoiaSettings.System.getInt(resolver,
                    EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, mDefaultColor);
            int callTimeOn = EunoiaSettings.System.getInt(resolver,
                    EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, mDefaultLedOn);
            int callTimeOff = EunoiaSettings.System.getInt(resolver,
                    EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, mDefaultLedOff);

            mCallPref.setAllValues(callColor, callTimeOn, callTimeOff);
        }

        if (mVoicemailPref != null) {
            int vmailColor = EunoiaSettings.System.getInt(resolver,
                    EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_COLOR, mDefaultColor);
            int vmailTimeOn = EunoiaSettings.System.getInt(resolver,
                    EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_ON, mDefaultLedOn);
            int vmailTimeOff = EunoiaSettings.System.getInt(resolver,
                    EunoiaSettings.System.NOTIFICATION_LIGHT_PULSE_VMAIL_LED_OFF, mDefaultLedOff);
