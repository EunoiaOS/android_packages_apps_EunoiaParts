...
public class BrightnessPreference extends CustomDialogPreference<AlertDialog>
    ...
    public BrightnessPreference(Context context, AttributeSet attrs) {
        ...
        bundle.putBoolean(EunoiaNotification.EXTRA_FORCE_SHOW_LIGHTS, true);
        bundle.putInt(EunoiaNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, LIGHT_BRIGHTNESS_MAXIMUM);
