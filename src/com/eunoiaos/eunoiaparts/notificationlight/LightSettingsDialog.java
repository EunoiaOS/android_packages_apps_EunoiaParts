...
import com.eunoiaos.internal.notification.LedValues;
...
public class LightSettingsDialog extends AlertDialog implements
    ...
    private void updateLed() {
        ...
        b.putBoolean(EunoiaNotification.EXTRA_FORCE_SHOW_LIGHTS, true);
        if  (mLedBrightness > 0 && mLedBrightness < LedValues.LIGHT_BRIGHTNESS_MAXIMUM) {
            b.putInt(EunoiaNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, mLedBrightness);
        }
        b.putInt(EunoiaNotification.EXTRA_FORCE_COLOR, color);
        b.putInt(EunoiaNotification.EXTRA_FORCE_LIGHT_ON_MS, speedOn);
        b.putInt(EunoiaNotification.EXTRA_FORCE_LIGHT_OFF_MS, speedOff);
