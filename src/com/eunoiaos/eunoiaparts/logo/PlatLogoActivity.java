...
package com.eunoiaos.eunoiaparts.logo;
...
public class PlatLogoActivity extends Activity {
    ...
    private class PBackground extends Drawable {
        ...
        // EunoiaOS logo drawable
        private final Drawable mLogo;

        public PBackground(Context context) {
            randomizePalette();
            // EunoiaOS logo
            mLogo = context.getResources().getDrawable(R.drawable.logo_eunoia, context.getTheme());
        ...
        public void draw(Canvas canvas) {
             ...
             * Sort of hacky. The Eunoia logo can be built with a bunch of circles.
    ...
    private void checkLongPressTimeout() {
        if (mTouchHeld > 0 && mTapCount >= 5) {
            if (System.currentTimeMillis() - mTouchHeld >= LONG_PRESS_TIMEOUT) {
                ...
                mLayout.post(() -> {
                    try {
                        startActivity(new Intent("com.eunoiaos.lineageparts.EASTER_EGG")
