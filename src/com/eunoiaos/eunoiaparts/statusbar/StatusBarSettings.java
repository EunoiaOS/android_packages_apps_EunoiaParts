...
public class StatusBarSettings extends SettingsPreferenceFragment
    ...
    private EunoiaSystemSettingListPreference mQuickPulldown;
    private EunoiaSystemSettingListPreference mStatusBarClock;
    private EunoiaSystemSettingListPreference mStatusBarAmPm;
    private EunoiaSystemSettingListPreference mStatusBarBatteryShowPercent;
    ...
    private int getNetworkTrafficStatus() {
        int mode = EunoiaSettings.Secure.getInt(getActivity().getContentResolver(),
                EunoiaSettings.Secure.NETWORK_TRAFFIC_MODE, 0);
        int position = EunoiaSettings.Secure.getInt(getActivity().getContentResolver(),
                EunoiaSettings.Secure.NETWORK_TRAFFIC_POSITION, /* Center */ 1);
