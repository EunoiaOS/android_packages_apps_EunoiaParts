...
package com.eunoiaos.eunoiaparts.atv;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public KeyHandler(Context context) {
        ...
        int[] keycodes = mContext.getResources().getIntArray(
                com.eunoiaos.platform.internal.R.array.keyhandler_keycodes);
        String[] packages = mContext.getResources().getStringArray(
                com.eunoiaos.platform.internal.R.array.keyhandler_packages);
