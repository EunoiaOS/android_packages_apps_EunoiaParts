...
package com.eunoiaos.eunoiaparts.input;
...
import com.eunoiaos.eunoiaparts.utils.TelephonyUtils;
import com.eunoiaos.internal.util.ScreenType;

import static com.eunoiaos.internal.util.DeviceKeysConstants.*;
...
public class ButtonSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHardware = EunoiaHardwareManager.getInstance(getActivity());
        ...
        final int torchLongPressPowerTimeout = EunoiaSettings.System.getInt(resolver,
                EunoiaSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT, 0);
        ...
        Action defaultBackLongPressAction = Action.fromIntSafe(res.getInteger(
                com.eunoiaos.platform.internal.R.integer.config_longPressOnBackBehavior));
        Action defaultHomeLongPressAction = Action.fromIntSafe(res.getInteger(
                com.eunoiaos.platform.internal.R.integer.config_longPressOnHomeBehavior));
        Action defaultHomeDoubleTapAction = Action.fromIntSafe(res.getInteger(
                com.eunoiaos.platform.internal.R.integer.config_doubleTapOnHomeBehavior));
        Action defaultAppSwitchLongPressAction = Action.fromIntSafe(res.getInteger(
                com.eunoiaos.platform.internal.R.integer.config_longPressOnAppSwitchBehavior));
        ...
        Action edgeLongSwipeAction = Action.fromSettings(resolver,
                EunoiaSettings.System.KEY_EDGE_LONG_SWIPE_ACTION,
                Action.NOTHING);
        ...
        if (hasMenuKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    EunoiaSettings.System.KEY_MENU_ACTION, Action.MENU);
        ...
        if (hasAssistKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    EunoiaSettings.System.KEY_ASSIST_ACTION, Action.SEARCH);
            mAssistPressAction = initList(KEY_ASSIST_PRESS, pressAction);

            Action longPressAction = Action.fromSettings(resolver,
                    EunoiaSettings.System.KEY_ASSIST_LONG_PRESS_ACTION, Action.VOICE_SEARCH);
        ...
        if (hasAppSwitchKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    EunoiaSettings.System.KEY_APP_SWITCH_ACTION, Action.APP_SWITCH);
        ...
        if (hasCameraKey) {
            ...
            if (res.getBoolean(com.eunoiaos.platform.internal.R.bool.config_singleStageCameraKey)) {
        ...
        if (mCameraWakeScreen != null) {
            if (mCameraSleepOnRelease != null && !res.getBoolean(
                    com.eunoiaos.platform.internal.R.bool.config_singleStageCameraKey)) {
    ...
    public void onResume() {
        ...
        if (mHomeAnswerCall != null) {
            final int incallHomeBehavior = EunoiaSettings.Secure.getInt(getContentResolver(),
                    EunoiaSettings.Secure.RING_HOME_BUTTON_BEHAVIOR,
                    EunoiaSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DEFAULT);
            final boolean homeButtonAnswersCall =
                (incallHomeBehavior == EunoiaSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER);
    ...
    private void handleListChange(ListPreference pref, Object newValue, String setting) {
        ...
        EunoiaSettings.System.putInt(getContentResolver(), setting, Integer.valueOf(value));
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mBackLongPressAction ||
            ...
            handleListChange(mTorchLongPressPowerTimeout, newValue,
                    EunoiaSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT);
            return true;
            ...
            mHardware.set(EunoiaHardwareManager.FEATURE_KEY_SWAP, (Boolean) newValue);
            return true;
            ...
            EunoiaSettings.System.putInt(getContentResolver(),
                    EunoiaSettings.System.ENABLE_TASKBAR, ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        return false;
    }
    ...
    private static void writeDisableNavkeysOption(Context context, boolean enabled) {
        EunoiaSettings.System.putIntForUser(context.getContentResolver(),
                EunoiaSettings.System.FORCE_SHOW_NAVBAR, enabled ? 1 : 0, UserHandle.USER_CURRENT);
    }

    private void updateDisableNavkeysOption() {
        boolean enabled = EunoiaSettings.System.getIntForUser(getActivity().getContentResolver(),
    ...
    private static boolean isKeySwapperSupported(Context context) {
        final EunoiaHardwareManager hardware = EunoiaHardwareManager.getInstance(context);
        return hardware.isSupported(EunoiaHardwareManager.FEATURE_KEY_SWAP);
    }
    ...
    public static void restoreKeyDisabler(Context context) {
        ...
        boolean enabled = EunoiaSettings.System.getIntForUser(context.getContentResolver(),
                EunoiaSettings.System.FORCE_SHOW_NAVBAR, 0, UserHandle.USER_CURRENT) != 0;
    ...
    public static void restoreKeySwapper(Context context) {
        ...
        final EunoiaHardwareManager hardware = EunoiaHardwareManager.getInstance(context);
        hardware.set(EunoiaHardwareManager.FEATURE_KEY_SWAP,
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mSwapVolumeButtons) {
            ...
            EunoiaSettings.System.putInt(getActivity().getContentResolver(),
                    EunoiaSettings.System.SWAP_VOLUME_KEYS_ON_ROTATION, value);
        } else if (preference == mVolumePanelOnLeft) {
            EunoiaSettings.Secure.putIntForUser(getActivity().getContentResolver(),
                    EunoiaSettings.Secure.VOLUME_PANEL_ON_LEFT,
    ...
    private void handleToggleHomeButtonAnswersCallPreferenceClick() {
        EunoiaSettings.Secure.putInt(getContentResolver(),
                EunoiaSettings.Secure.RING_HOME_BUTTON_BEHAVIOR, (mHomeAnswerCall.isChecked()
                        ? EunoiaSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER
                        : EunoiaSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DO_NOTHING));
    }
