...
public class ButtonBacklightBrightness extends CustomDialogPreference<AlertDialog> implements
    ...
    public ButtonBacklightBrightness(Context context, AttributeSet attrs) {
        ...
        if (DeviceUtils.hasKeyboardBacklightSupport(context)) {
            final boolean isSingleValue = KEYBOARD_BRIGHTNESS_TOGGLE_MODE_ONLY ==
                    context.getResources().getInteger(com.eunoiaos.platform.internal.R.integer
                            .config_deviceSupportsKeyboardBrightnessControl);
            mKeyboardBrightness = new BrightnessControl(
                    EunoiaSettings.Secure.KEYBOARD_BRIGHTNESS, isSingleValue);
        ...
        if (DeviceUtils.hasButtonBacklightSupport(context)) {
            ...
            float defaultBrightness = context.getResources().getFloat(
                    com.eunoiaos.platform.internal.R.dimen
            ...
            mButtonBrightness = new ButtonBrightnessControl(
                    ...
                    EunoiaSettings.System.BUTTON_BACKLIGHT_ONLY_WHEN_PRESSED,
    ...
    private int getTimeout() {
        return EunoiaSettings.Secure.getInt(mResolver,
                EunoiaSettings.Secure.BUTTON_BACKLIGHT_TIMEOUT, DEFAULT_BUTTON_TIMEOUT * 1000) / 1000;
    }

    private void applyTimeout(int timeout) {
        EunoiaSettings.Secure.putInt(mResolver,
                EunoiaSettings.Secure.BUTTON_BACKLIGHT_TIMEOUT, timeout * 1000);
    }
    ...
    private class BrightnessControl implements
        ...
        public float getBrightness(boolean persisted) {
            ...
            return EunoiaSettings.Secure.getFloat(mResolver, mSetting, mDefaultBrightness);
        }

        public void applyBrightness() {
            EunoiaSettings.Secure.putFloat(mResolver, mSetting, getBrightness(false));
        }
    ...
    private class ButtonBrightnessControl extends BrightnessControl {
        ...
        public boolean isOnlyWhenPressedEnabled() {
            return EunoiaSettings.System.getInt(mResolver, mOnlyWhenPressedSetting, 0) == 1;
        }

        public void setOnlyWhenPressedEnabled(boolean enabled) {
            EunoiaSettings.System.putInt(mResolver, mOnlyWhenPressedSetting, enabled ? 1 : 0);
        }
    }
}
