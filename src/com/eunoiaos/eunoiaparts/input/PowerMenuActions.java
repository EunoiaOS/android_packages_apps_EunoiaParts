...
import eunoiaos.app.EunoiaGlobalActions;
import eunoiaos.providers.EunoiaSettings;

import static com.eunoiaos.internal.util.PowerMenuConstants.*;
...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    private EunoiaGlobalActions mEunoiaGlobalActions;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEunoiaGlobalActions = EunoiaGlobalActions.getInstance(mContext);
        ...
        mLocalUserConfig = mEunoiaGlobalActions.getLocalUserConfig();
    }
    ...
    public void onStart() {
        ...
        if (mScreenshotPref != null) {
            mScreenshotPref.setChecked(mEunoiaGlobalActions.userConfigContains(
                    GLOBAL_ACTION_KEY_SCREENSHOT));
        }

        if (mAirplanePref != null) {
            mAirplanePref.setChecked(mEunoiaGlobalActions.userConfigContains(
        ...
        if (mUsersPref != null) {
            if (!UserHandle.MU_ENABLED || !UserManager.supportsMultipleUsers()) {
                ...
                mUsersPref.setChecked(mEunoiaGlobalActions.userConfigContains(
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mScreenshotPref) {
            ...
            mEunoiaGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_SCREENSHOT);

        } else if (preference == mAirplanePref) {
            value = mAirplanePref.isChecked();
            mEunoiaGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_AIRPLANE);

        } else if (preference == mUsersPref) {
            value = mUsersPref.isChecked();
            mEunoiaGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_USERS);

        } else if (preference == mBugReportPref) {
            value = mBugReportPref.isChecked();
            mEunoiaGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_BUGREPORT);
            Settings.Global.putInt(getContentResolver(),
                    Settings.Global.BUGREPORT_IN_POWER_MENU, value ? 1 : 0);

        } else if (preference == mEmergencyPref) {
            value = mEmergencyPref.isChecked();
            mEunoiaGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_EMERGENCY);

        } else if (preference == mDeviceControlsPref) {
            value = mDeviceControlsPref.isChecked();
            mEunoiaGlobalActions.updateUserConfig(value, GLOBAL_ACTION_KEY_DEVICECONTROLS);
