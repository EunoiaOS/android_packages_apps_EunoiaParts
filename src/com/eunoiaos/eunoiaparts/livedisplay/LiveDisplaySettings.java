 ...
 */
package com.eunoiaos.eunoiaparts.livedisplay;
...
import com.eunoiaos.eunoiaparts.search.SearchIndexableRaw;
import com.eunoiaos.eunoiaparts.search.Searchable;
import com.eunoiaos.eunoiaparts.utils.ResourceUtils;
...
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_ANTI_FLICKER;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_CABC;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_COLOR_ADJUSTMENT;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_COLOR_ENHANCEMENT;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_DISPLAY_MODES;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_PICTURE_ADJUSTMENT;
import static eunoiaos.hardware.LiveDisplayManager.FEATURE_READING_ENHANCEMENT;
...
public class LiveDisplaySettings extends SettingsPreferenceFragment implements Searchable,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] modeEntries = res.getStringArray(
                com.eunoiaos.platform.internal.R.array.live_display_entries);
        mModeValues = res.getStringArray(
                com.eunoiaos.platform.internal.R.array.live_display_values);
        mModeSummaries = res.getStringArray(
                com.eunoiaos.platform.internal.R.array.live_display_summaries);
        ...
        if (liveDisplayPrefs != null && mReadingMode != null &&
                !mHardware.isSupported(EunoiaHardwareManager.FEATURE_READING_ENHANCEMENT)) {
        ...
        if (liveDisplayPrefs != null && antiFlicker != null &&
                !mHardware.isSupported(EunoiaHardwareManager.FEATURE_ANTI_FLICKER)) {
    ...
    private void updateReadingModeStatus() {
        if (mReadingMode != null) {
            mReadingMode.setChecked(
                    mHardware.get(EunoiaHardwareManager.FEATURE_READING_ENHANCEMENT));
        }
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mLiveDisplay) {
            ...
            mHardware.set(EunoiaHardwareManager.FEATURE_READING_ENHANCEMENT, (Boolean) objValue);
        }
        return true;
    }
    ...
    public static final Searchable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public Set<String> getNonIndexableKeys(Context context) {
            ...
            if (!context.getResources().getBoolean(
                    com.eunoiaos.platform.internal.R.bool.config_enableLiveDisplay)) {
                result.add(KEY_LIVE_DISPLAY_TEMPERATURE);
                result.add(KEY_LIVE_DISPLAY);
            }
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context) {
            ...
            if (config.hasFeature(FEATURE_DISPLAY_MODES)) {
                DisplayMode[] modes = EunoiaHardwareManager.getInstance(context).getDisplayModes();
                if (modes != null && modes.length > 0) {
