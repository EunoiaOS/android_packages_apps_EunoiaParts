...
package com.eunoiaos.eunoiaparts.gestures;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    private static final String GESTURE_WAKEUP_REASON = "eunoiaparts-gesture-wakeup";
    ...
    public KeyHandler(final Context context) {
        ...
        mGestureWakeLock = mPowerManager.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK, "EunoiaPartsGestureWakeLock");
        ...
        if (mProximityWakeSupported) {
            mProximityTimeOut = resources.getInteger(
                    com.eunoiaos.platform.internal.R.integer.config_proximityCheckTimeout);
            mDefaultProximity = mContext.getResources().getBoolean(
                    com.eunoiaos.platform.internal.R.bool.config_proximityCheckOnWakeEnabledByDefault);

            mSensorManager = context.getSystemService(SensorManager.class);
            mProximitySensor = mSensorManager.getDefaultSensor(Sensor.TYPE_PROXIMITY);
            mProximityWakeLock = mPowerManager.newWakeLock(
                    PowerManager.PARTIAL_WAKE_LOCK, "EunoiaPartsProximityWakeLock");
        }
    ...
    public KeyEvent handleKeyEvent(final KeyEvent event) {
        ...
        if (action != 0 && !mEventHandler.hasMessages(GESTURE_REQUEST)) {
            ...
            final boolean proxWakeEnabled = EunoiaSettings.System.getInt(mContext.getContentResolver(),
                    EunoiaSettings.System.PROXIMITY_ON_WAKE, mDefaultProximity ? 1 : 0) == 1;
    ...
    private void launchCamera() {
        ...
        final Intent intent = new Intent(eunoiaos.content.Intent.ACTION_SCREEN_CAMERA_GESTURE);
    ...
    private void doHapticFeedback() {
        ...
        if (mAudioManager.getRingerMode() != AudioManager.RINGER_MODE_SILENT) {
            final boolean enabled = EunoiaSettings.System.getInt(mContext.getContentResolver(),
                    EunoiaSettings.System.TOUCHSCREEN_GESTURE_HAPTIC_FEEDBACK, 1) != 0;
            if (enabled) {
