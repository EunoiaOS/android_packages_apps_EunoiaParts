...
public class Utilities {
    ...
    public static String getDevice() {
        return SystemProperties.get("ro.eunoia.device", Build.PRODUCT);
    }

    public static String getModVersion() {
        return SystemProperties.get("ro.eunoia.version", Build.DISPLAY);
    }
    ...
    public static boolean isStatsCollectionEnabled(Context context) {
        return EunoiaSettings.Secure.getInt(context.getContentResolver(),
                EunoiaSettings.Secure.STATS_COLLECTION, 1) != 0;
    }
    ...
    public static void setStatsCollectionEnabled(Context context, boolean enabled) {
        ...
        EunoiaSettings.Secure.putInt(context.getContentResolver(),
                EunoiaSettings.Secure.STATS_COLLECTION, enable);
    }
