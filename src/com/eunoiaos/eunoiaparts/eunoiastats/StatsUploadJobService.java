...
public class StatsUploadJobService extends JobService {
    ...
    public static final int JOB_TYPE_EUNOIACOM = 1;
    ...
    private boolean uploadToEunoia(JSONObject json) throws IOException {
        final Uri uri = Uri.parse(getString(R.string.stats_eunoia_url));
        ...
        try {
            ...
            if (DEBUG) Log.d(TAG, "eunoia server response code=" + responseCode);
